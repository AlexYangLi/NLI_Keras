...
class ELMoEmbedding(Layer):
    ...
    """
    def __init__(self, output_mode, idx2word=None, max_length=None, mask_zero=False, hub_url=None, trainable=None,
                 **kwargs):
        """
        ...
        # load elmo model locally by providing a local path due to the huge delay downloading the model
    ...
    def build(self, input_shape):
        ...
        print('load elmo from tensorflow hub....')
    ...
    def compute_mask(self, inputs, mask=None):
        if not self.mask_zero or self.input_type == 'sentence':     # hard to compute mask when using sentences as input
            return None
